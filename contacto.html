  ...
  <div class="collapse navbar-collapse" id="navbarNav">
	...
	<div align="center">
		...
		<table>
			...
			<tr>
				<td>Telefono</td>
				<td><input type="type" name="tel" required placeholder="Telefono Celular"></td>
			</tr>
			<tr>
				<td>Correo</td>
			...
			<tr>
				<td>Comentarios</td>
				<td>
					<textarea type="text" cols="30" rows="5" name="asunto" required placeholder="¿En que podemos ayudarte?"></textarea>
				</td>
			</tr>
			<tr>
				<th colspan="2">
